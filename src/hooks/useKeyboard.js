...
export function useKeyboard({ note, noteRef, update, changeFontSize, changeOpacity, setEditingTitle }) {
  useEffect(() => {
    if (!note) return;
  ...
  }, [note, noteRef, update, changeFontSize, changeOpacity, setEditingTitle]);
}
